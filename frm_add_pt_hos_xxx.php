                ...
                <form action="qry_add_pt_hos.php" 
                    ...
                    <ul data-role="listview" data-inset="true">
                        ...
                        <li data-role="fieldcontain">
                            ...
                            <input type="text" name="occupat" id="occupat" data-clear-btn="true" placeholder="อาชีพ">
                        </li>
                        <li data-role="fieldcontain">
                        ...
                        <li data-role="fieldcontain">
                            <label for="note_text">รายละเอียดอื่นๆ(ถ้ามี):</label>
                            <textarea cols="40" rows="8" name="note_text" id="note_text" placeholder="อื่นๆ"></textarea>
                        </li>
